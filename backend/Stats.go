...
// Combines all parts generated by the functions below into one PDF and returns it as a Maroto object
...
// Calculates the total revenue and total cancellations, then adds them to the PDF
...
// Calculates the total number of sold items and subtracts the canceled items, then adds the result to the PDF
...
// Calculates the revenue per waiter, then adds it to the PDF
...
// Calculates the revenue per category, then adds it to the PDF
...
// Calculates the total number of sold items per category, subtracts the canceled items, then adds the result to the PDF
